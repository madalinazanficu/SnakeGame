...
module Colors = struct
  ...
  let game_won2 = Graphics.rgb 100 100 100
...
let draw_header ~game_state ~score =
  ...
  let header_color =
    ...
    | Win_snake1 _ -> Colors.game_won
    | Win_snake2 _ -> Colors.game_won2
  in
...
let draw_snake snake_head snake_tail snake2_head snake2_tail =
